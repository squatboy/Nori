...
struct BiseokChigiView: View {
    ...
    var rightView: some View {
        ZStack {
            VStack {
                if !isButtonClicked {
                    Text("Click the button to watch AR simulation of BiseokChigi")
                        .font(.largeTitle)
                        .padding()
                    Button {
    ...
    var textView: some View {
        ScrollView {
            VStack(spacing: 10) {
                Text("BiseokChigi is a traditional Korean board game that has been enjoyed for centuries. It is a strategic and entertaining game that is often played during festive occasions, family gatherings, and holidays.")
                ...
                Text("BiseokChigi is typically played on a square board divided into 29 spaces. The spaces are arranged in a specific pattern, and each player has four game pieces, usually small sticks or tokens.")
                ...
                Text("The goal of BiseokChigi is to move all of your pieces around the board, following a specific path, and eventually reach the center space called 'Bang'")
